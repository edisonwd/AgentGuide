...
- 完整路线：[2026 Agent 求职通关路线](05-roadmaps/agent-job-ready-roadmap-2026.md)
- 项目落地方法：[如何落地一个可写进简历的 Agent 项目](03-practice/05-ship-agent-project.md)
- 工程核心专题：[Agent Harness Engineering](02-tech-stack/27-agent-harness-engineering.md)
...
**📖 完整技术方向详解**：[转行大模型热门方向准备指南](04-interview/06-career-transition.md)
...
**🚀 新手推荐**：
- 📘 [**AgentGuide开源学习路线（简易版）**](05-roadmaps/AgentGuide开源学习路线（简易版本）.md) - **从零到Offer完整路径**，8-15周系统化学习方案，包含完整资源清单 ⭐⭐⭐
...
**👉 [查看详细路线图](05-roadmaps/learning-roadmap-algorithm.md)**
...
**👉 [查看详细路线图](05-roadmaps/learning-roadmap-development.md)**
...
📖 [阅读：什么是 AI Agent？](01-theory/01-what-is-agent.md)
...
📖 [阅读：Agent 技术演进史](01-theory/02-agent-history.md)
...
📖 [深入阅读：Transformer 架构详解](01-theory/03-transformer.md)  
...
📖 [实战教程：手撕 ReAct](01-theory/04-react-framework.md)  
📖 [实战教程：规划与执行](01-theory/05-cot-and-planning.md)
...
📖 [框架对比：如何选择？](02-tech-stack/04-langchain-guide.md)  
...
| 框架 | 核心特性 | 适用场景 | 学习资源 |
|:-----|:---------|:---------|:---------|
| **LangGraph** | 图导向、状态管理、循环控制 | 复杂工作流、需要精确控制的场景 | [📖 完整教程](02-tech-stack/04-langchain-guide.md) |
| **AutoGen** | 多 Agent 对话、角色扮演 | 团队协作、复杂任务分解 | [📖 实战指南](02-tech-stack/06-multi-agent-frameworks.md) |
| **AgentScope** | 消息驱动、灵活扩展 | 国内场景、中文优化 | [📖 快速上手](02-tech-stack/07-agentscope.md) |
| **CrewAI** | 角色分工、层级管理 | 企业级应用、流程自动化 | [📖 企业实战](02-tech-stack/06-multi-agent-frameworks.md) |
...
📖 [实战项目：打造自己的 Agent 框架](02-tech-stack/22-build-your-agent-framework.md)
...
📖 [完整教程：RAG 系统开发指南](02-tech-stack/20-rag-full-pipeline.md)  
...
📖 [必读：上下文工程资源合集](02-tech-stack/13-context-engineering-resources.md) 🔥  
📖 [深度指南：Context Engineering 2.0](02-tech-stack/18-context-engineering-guide.md)
...
📖 [协议详解：MCP 完全指南](02-tech-stack/14-mcp-protocol.md)
...
📖 [完整指南：Agent 强化学习](02-tech-stack/21-agent-reinforcement-learning.md)  
📖 [实战：SFT 监督微调](02-tech-stack/16-sft-finetuning.md)  
📖 [Post-Training 完整面试指南](02-tech-stack/25-post-training-complete-guide.md) 🆕
...
📖 [评估指南：科学评估 Agent](01-theory/09-evaluation-metrics.md)
📖 [AgentBench 详解](01-theory/08-agent-bench.md)
📖 [🔥 **AI Agent 评估完全指南** (Anthropic官方万字长文)](02-tech-stack/agent-evaluation-complete-guide.md) ⭐ **必读**
...
📖 [完整指南：高可用 RAG 系统](03-practice/02-high-availability-rag.md)  
📖 [安全性指南](03-practice/03-agent-security.md)
...
**理论基础（必学）**
- [x] [📘 LLM/VLM/RLHF理论题](04-interview/01-theory-questions.md)
...
**RAG系统（开发岗重点）**
- [x] [📊 RAG全流程题](04-interview/02-rag-questions.md)
  - **核心原理**: 检索、索引、生成
...
**Agent开发（核心）**
- [x] [🤖 Agent系统题](04-interview/03-agent-questions.md)
...
**编程实战（必备）**
- [x] [💻 手撕代码题](04-interview/04-coding-questions.md)
...
- [x] [💻 大模型手撕刷题路线](04-interview/17-coding-exercises.md) 🆕
...
- [x] [🔬 算法岗专项](04-interview/05-algorithm-specialized.md) - 算法创新/推导/实验/论文 **45题**
- [x] [🛠️ 开发岗专项](04-interview/06-development-specialized.md) - 系统设计/工程实践/选型/落地 **45题**

**🏢 真实面经与进阶**

- [x] [📋 大厂真实面经](04-interview/12-company-interview-cases.md) - 美团/字节/阿里等16个完整案例
- [x] [🧭 AI Agent 面试备战手册合集](04-interview/18-agent-interview-playbooks/) - Memory、Skills、Harness、评估、数据合成、源码分析与项目话术
- [x] [📊 模型评估专题](04-interview/13-model-evaluation.md) - BLEU/ROUGE、基准测试、LLM-as-Judge **10题**
- [x] [🔮 前景与趋势](04-interview/14-llm-future-trends.md) - AGI、多模态、世界模型等开放讨论 **9题**
- [x] [💬 开放性讨论](04-interview/15-open-discussion.md) - 技术判断、学习建议、核心素质 **8题**
...
#### 求职软技能
- [x] [📝 简历编写指南](04-interview/12-resume-guide.md) - AI Agent 项目简历公式、双岗写法与自检脚本
- [x] [🎤 项目讲述技巧](04-interview/13-storytelling.md) - STAR+Tech 项目表达、追问地图与复盘模板
- [x] [⭐ 转行大模型指南](04-interview/07-career-transition.md)
- [x] [⭐ 秋招完整攻略](04-interview/08-job-hunting-guide.md)
...
#### 面试软技能（新增⭐）
- [x] [⭐ 校招生谈薪实用指南](04-interview/09-salary-negotiation.md) - 3大原则、话术模板
- [x] [⭐ HR面试完全攻略](04-interview/10-hr-interview.md) - 10大高频问题应对
- [x] [⭐ 秋招心态调整指南](04-interview/11-mindset.md) - 保持好心态拿Offer
...
- 🚀 [AgentGuide开源学习路线（简易版）](05-roadmaps/AgentGuide开源学习路线（简易版本）.md) - 从零到Offer完整路径（8-15周）⭐ 新增
- 🔬 [算法岗详细路线](05-roadmaps/learning-roadmap-algorithm.md) - 每日学习计划
- 🛠️ [开发岗详细路线](05-roadmaps/learning-roadmap-development.md) - 每日学习计划

### 💼 实战方法
- 🛠️ [如何落地一个可写进简历的 Agent 项目](03-practice/05-ship-agent-project.md) - Spec、AI 编程环境、项目理解 Skill、Eval 和消融实验
